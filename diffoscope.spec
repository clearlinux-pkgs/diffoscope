...
%prep
%setup -q -n diffoscope-163
cd %{_builddir}/diffoscope-163
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607704761
...
cp %{_builddir}/diffoscope-163/COPYING %{buildroot}/usr/share/package-licenses/diffoscope/8624bcdae55baeef00cd11d5dfcfa60f68710a02
